...
| `formal_physics/` | Lean 4 formalization of Taylor's *Classical Mechanics* (Ch. 6, 7, 13) using the Mathlib library | *Classical Mechanics* (John R. Taylor); [Mathlib4](https://github.com/leanprover-community/mathlib4) (Apache-2.0); Lean 4 (Apache-2.0) |
| `formal_statistics/` | Lean 4 formalization of Kutner's regression analysis (Ch. 1, 2) using the Mathlib library | *Applied Linear Statistical Models* (Kutner, Nachtsheim & Neter); [Mathlib4](https://github.com/leanprover-community/mathlib4) (Apache-2.0); Lean 4 (Apache-2.0) |
