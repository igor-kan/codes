#!/usr/bin/env bash
# ==============================================================================
# Verify the Formal Physics Lean 4 library.
#
...
echo "==> Building FormalPhysics..."
lake build

echo "==> Checking for unfinished proofs..."
if grep -rn --include='*.lean' -E '\b(sorry|admit)\b' FormalPhysics FormalPhysics.lean; then
  echo "ERROR: found sorry/admit" >&2
  exit 1
fi

echo "==> All formal physics modules verified."
