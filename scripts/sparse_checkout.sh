...
CORE_PATHS=(
  "algorithms"
  "architectures/api_design"
  "architectures/architecture_styles"
  "architectures/clean_architecture"
  "architectures/cloud_patterns"
  "architectures/concurrency_patterns"
  "architectures/cpp_patterns"
  "architectures/data_patterns"
  "architectures/ddd_patterns"
  "architectures/deployment_patterns"
  "architectures/distributed_patterns"
  "architectures/enterprise_patterns"
  "architectures/event_driven_patterns"
  "architectures/functional_patterns"
  "architectures/go_patterns"
  "architectures/integration_patterns"
  "architectures/java_patterns"
  "architectures/microservices_patterns"
  "architectures/observability_patterns"
  "architectures/principles"
  "architectures/python_patterns"
  "architectures/resilience_patterns"
  "architectures/rust_patterns"
  "architectures/security_patterns"
  "architectures/system_design"
  "architectures/templates"
  "architectures/testing_patterns"
