function rayleighQuotient(matrix, vector, iterations = 100) {
...
module.exports = { rayleighQuotient };

if (require.main === module) {
  const { eigenvalue } = rayleighQuotient([[2, 1], [1, 2]], [1, 0]);
  if (Math.abs(eigenvalue - 3) > 1e-9) throw new Error("rayleigh quotient failed");
  console.log("[JavaScript Rayleigh Quotient] eigenvalue verified");
}
